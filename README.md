...
* ESP32 // I used the TTGO T7 V1.3, what every esp32 you use must have built in Bluetooth.
...
* 6 Two terminal Screw terminal blocks // I used these, https://www.amazon.com/DGZZI-50pcs-Terminal-Connector-Arduino/dp/B07SZFGH4B/ref=sr_1_5?crid=5CSNFZ1R5NCE&dchild=1&keywords=pcb+screw+terminal+block&qid=1630437130&s=industrial&sprefix=pcb+scre%2Cindustrial%2C169&sr=1-5
...
* Lastly, Things like the Arm,PWR LED's and ARM Switch will need 22AWG wire to extend from the PCB to the 3D Printed case. 


After the circuit is built, this code must be uploaded to the ESP-32.
Coppy and past the Arduino Code into the Arduino IDE. To use a ESP-32 with Arduino IDE, you must click on " File ", then " Preferences ". Go to " Sketchbook Loacation: " and past " https://dl.espressif.com/dl/package_esp32_index.json " and click " OK ".
